...
<div className="flex flex-col justify-center items-center ">
      <h1 className="text-center text-2xl">I'm sorry, it seems that some of the Lightning Network emails you entered are incorrect. If you wish to recover your satoshis, you can scan or copy the following QR code</h1>
